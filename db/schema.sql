...
CREATE TABLE IF NOT EXISTS billing.cart
(
...
CREATE TABLE IF NOT EXISTS billing.sale
(
...
CREATE TABLE IF NOT EXISTS billing.sale_item
(
...
CREATE TABLE IF NOT EXISTS billing.movie_price
(
